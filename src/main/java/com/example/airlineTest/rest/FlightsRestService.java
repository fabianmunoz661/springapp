package com.example.airlineTest.rest;

import java.util.Map;
import java.util.Map.Entry;

import com.example.airlineTest.model.AircraftFleet;
import com.example.airlineTest.model.Flight;
import com.example.airlineTest.model.Passenger;
...
public class FlightsRestService {
    ...
    public @ResponseBody String welcome() {
        ...
        return "***** WELCOME TO SPRING AIRLINES 3 *****";
    }
